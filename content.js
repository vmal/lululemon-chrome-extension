...
function createModal() {
  ...
  // Load the content of the modal from https://lulu-shop-git-retrieval-step-lintonye.vercel.app/
  modal.innerHTML = `
  <header style="width:499px; border-radius: 8px 8px 0 0" class="chat-header_modalHeader__mg_f2">
  ...
  <iframe src="https://lulu-shop-git-retrieval-step-lintonye.vercel.app/" id="popup-content" style="flex: 1; width: 100%; border: none;"></iframe>
  `;
