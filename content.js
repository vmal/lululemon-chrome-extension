...
function createModal() {
  ...
  // Load the content of the modal from https://lulu-shop-git-brand-voice-lintonye.vercel.app/
  modal.innerHTML = `
  ...
  <iframe src="https://lulu-shop-git-brand-voice-lintonye.vercel.app/" id="popup-content" style="flex: 1; width: 100%; border: none;"></iframe>
  `;
